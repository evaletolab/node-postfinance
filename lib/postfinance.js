...
Card.prototype.publish = function(options, callback) {
  ...
  var operation={
    ...
    'SAL':'order',
    'SAL':'order',
    'RFS':'maintenance',// refund
    'DES':'maintenance', // cancel
    'DEL':'maintenance', // cancel
    'REN':'maintenance' // renew
  }
 ...
 * @param {Function} callback Called with err object
 */
Card.prototype.redact = function(opts,callback) {
